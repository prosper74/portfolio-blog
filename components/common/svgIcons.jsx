...
export const GithubIcon = ({ width, height, fill = '' }) => {
  return (
    <svg
      width={width}
      height={height}
...
export const LinkedinAltIcon = ({ width, height, fill }) => {
  return (
    <svg
      width={width}
      height={height}
...
export const OtherSkillsIcon = ({ width, height, fill }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <g data-name="Layer 2">
        <path
          fill={fill}
          d="M28.47,44H19.53a1,1,0,0,1-1-.67l-1-2.77a17.5,17.5,0,0,1-4.78-2.75L10,38.35a1,1,0,0,1-1.06-.48L4.44,30.13A1,1,0,0,1,4.55,29l1.91-2.22a17.42,17.42,0,0,1,0-5.52L4.55,19a1,1,0,0,1-.11-1.15l4.47-7.74A1,1,0,0,1,10,9.65l2.87.54a17.5,17.5,0,0,1,4.78-2.75l1-2.77a1,1,0,0,1,1-.67h8.94a1,1,0,0,1,1,.67l1,2.77a17.5,17.5,0,0,1,4.78,2.75L38,9.65a1,1,0,0,1,1.06.48l4.47,7.74A1,1,0,0,1,43.45,19l-1.91,2.22a17.42,17.42,0,0,1,0,5.52L43.45,29a1,1,0,0,1,.11,1.15l-4.47,7.74a1,1,0,0,1-1.06.48l-2.87-.54a17.5,17.5,0,0,1-4.78,2.75l-1,2.77A1,1,0,0,1,28.47,44Zm-8.23-2h7.52l.88-2.54a1,1,0,0,1,.61-.61,15.65,15.65,0,0,0,5-2.87,1,1,0,0,1,.84-.23l2.64.51,3.76-6.52-1.75-2a1,1,0,0,1-.23-.83,15.5,15.5,0,0,0,0-5.76,1,1,0,0,1,.23-.83l1.75-2-3.76-6.52-2.64.51a1,1,0,0,1-.84-.23,15.65,15.65,0,0,0-5-2.87,1,1,0,0,1-.61-.61L27.76,6H20.24l-.88,2.54a1,1,0,0,1-.61.61,15.65,15.65,0,0,0-5,2.87,1,1,0,0,1-.84.23l-2.64-.51L6.53,18.26l1.75,2a1,1,0,0,1,.23.83,15.49,15.49,0,0,0,0,5.76,1,1,0,0,1-.23.83l-1.75,2,3.76,6.52,2.64-.51a1,1,0,0,1,.84.23,15.65,15.65,0,0,0,5,2.87,1,1,0,0,1,.61.61Z"
        ></path>
        <path
          fill={fill}
          d="M24,37a12.72,12.72,0,0,1-5.42-1.19,9.26,9.26,0,0,1-1.09-.56,13,13,0,1,1,13,0,8.67,8.67,0,0,1-1.1.55A12.57,12.57,0,0,1,24,37Zm0-24a11,11,0,0,0-5.5,20.52,6.31,6.31,0,0,0,.9.46,10.91,10.91,0,0,0,9.18,0,7,7,0,0,0,.91-.46A11,11,0,0,0,24,13Z"
        ></path>
        <path
          fill={fill}
          d="M24,37a12.72,12.72,0,0,1-5.42-1.19A1,1,0,0,1,18,34.9V25a1,1,0,0,1,.15-.53l5-8a1,1,0,0,1,1.7,0l5,8A1,1,0,0,1,30,25v9.9a1,1,0,0,1-.58.91A12.72,12.72,0,0,1,24,37Zm-4-2.76a10.94,10.94,0,0,0,8,0v-9l-4-6.4-4,6.4Z"
        ></path>
        <path
          fill={fill}
          d="M24 29c-3.36 0-6-1.76-6-4a1 1 0 0 1 2 0c0 .94 1.71 2 4 2s4-1.06 4-2a1 1 0 0 1 2 0C30 27.24 27.36 29 24 29zM24 23a5 5 0 0 1-3.19-1.15 1 1 0 0 1-.21-1.3l2.55-4.08a1 1 0 0 1 1.7 0l2.55 4.08a1 1 0 0 1-.21 1.3A5 5 0 0 1 24 23zm-1.17-2.24a3.06 3.06 0 0 0 2.34 0L24 18.89z"
        ></path>
      </g>
    </svg>
  );
...
export const FavouriteIcon = ({ width, height }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const LikeIcon = ({ width, height }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
